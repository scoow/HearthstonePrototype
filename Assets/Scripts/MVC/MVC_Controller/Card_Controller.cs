...
namespace Hearthstone
{
    public class Card_Controller : MonoBehaviour
    {
        ...
        public void ActivateBattleCry(/*Transform newParent*/Card card) //активаци€ боевых кличей
        {
        ...
        public void ChangeHealtValue(int incomingValue) //измен€ем значение здоровь€
        {
